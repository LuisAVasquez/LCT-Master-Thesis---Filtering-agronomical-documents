...
\def\Title{
%{\Huge \input{Chapters/00_Preamble/Title} }\\
NLP Meets Agronomy:\\
Document Classification for Plant Health Surveillance\\
%Long Title\\that can Span Multiple Lines\\
}

%% The ``short'' title of the work.
%% This will be put in the header of the document. Let it be \Title in the case
%% is short enough
\def\ShortTitle{Document Classification for Plant Health Surveillance}
