...
Usually, these algorithms produce different tokenizations of the same text, and thus, different vocabularies. Figure \ref{fig:02_tokenizer_comparison} show a sample output from the \gls{wp} implementation in \mytextcite{BERT_paper} and the \gls{bpe} implementation in \mytextcite{roberta} for English text.
