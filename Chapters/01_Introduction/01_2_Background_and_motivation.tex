...
As in many domains, \gls{ai} and \gls{nlp} have been starting to be adopted for Biomedical purposes, with promising results \myparencite{BioMedicalBERT_ALBERT_ELECTRA_2021,BioNER_with_multilingualBERT_2019}. 
